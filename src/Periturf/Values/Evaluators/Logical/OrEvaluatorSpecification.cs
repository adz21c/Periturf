...
{
    class OrEvaluatorSpecification<TInput> : IValueEvaluatorSpecification<TInput>
    {
        private readonly IValueEvaluatorSpecification<TInput>[] _conditions;

        public OrEvaluatorSpecification(params IValueEvaluatorSpecification<TInput>[] conditions)
        {
