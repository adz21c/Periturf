...
namespace Periturf.Tests.Values.Evaluators.Logical
{
    class OrEvaluatorTests
    {
        ...
        public async Task Given_Criterias_When_Or_Then_Result(bool criteriaOneResult, bool criteriaTwoResult, bool sutResult)
        {
            ...
            var spec = new OrEvaluatorSpecification<object>(criteriaOneSpec, criteriaTwoSpec);
            var sut = spec.Build();
