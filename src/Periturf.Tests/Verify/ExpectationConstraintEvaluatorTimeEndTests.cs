...
{
    [TestFixture]
    class ExpectationConstraintEvaluatorTimeEndTests
    {
        ...
        [TestCase(101, true, true, Description = "Before upper bound")]
        [TestCase(100, true, true, Description = "On upper bound")]
        ...
        [TestCase(101, false, null, Description = "Before upper bound")]
        [TestCase(100, false, null, Description = "On upper bound")]
        [TestCase(99, true, false, Description = "After upper bound")]
